!function(t, e) {
    ...
    var P, L = function(t) {
        ...
        se.isVisible() && P !== t.target.value && se.resetValidationMessage(),
        P = t.target.value
    }, st = function(t) {
        if (function() {
            var t = R();
            t && (t.parentNode.removeChild(t),
            T([document.documentElement, document.body], [C["no-backdrop"], C["toast-shown"], C["has-column"]]))
        }(),
        it())
            h("SweetAlert2 requires document to initialize");
        else {
            var e = document.createElement("div");
            e.className = C.container,
            e.innerHTML = rt;
            var n = function(t) {
    ...
    function dt(t, e, n) {
        I(t, n["showC" + e.substring(1) + "Button"], "inline-block"),
        t.innerHTML = n[e + "ButtonText"],
        t.setAttribute("aria-label", n[e + "ButtonAriaLabel"]),
        t.className = C[e],
        S(t, n.customClass, e + "Button"),
        O(t, n[e + "ButtonClass"])
    }
    var pt = function(t, e) {
        var n = J()
          , o = Y()
          , i = $();
        e.showConfirmButton || e.showCancelButton ? j(n) : q(n),
        S(n, e.customClass, "actions"),
        dt(o, "confirm", e),
        dt(i, "cancel", e),
    ...
    var ft = function(t, e) {
        ...
        !e.backdrop && e.allowOutsideClick && g('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'),
        function(t, e) {
            e in C ? O(t, C[e]) : (g('The "position" parameter is not valid, defaulting to "center"'),
            O(t, C.center))
        }(n, e.position),
        function(t, e) {
        ...
        S(n, e.customClass, "container"),
        e.customContainerClass && O(n, e.customContainerClass))
    }
      , mt = {
        promise: new WeakMap,
      ...
      , ht = function(t, e, n) {
        t.className = e,
        n.inputClass && O(t, n.inputClass),
        n.customClass && O(t, n.customClass.input)
    }
      , vt = function(t, e) {
    ...
    bt.text = bt.email = bt.password = bt.number = bt.tel = bt.url = function(t) {
        var e = M(K(), C.input);
        return "string" == typeof t.inputValue || "number" == typeof t.inputValue ? e.value = t.inputValue : y(t.inputValue) || g('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(f(t.inputValue), '"')),
        vt(e, t),
        e.type = t.input,
        e
    }
    ...
    var yt = function(t, e) {
        ...
        e.html ? (ut(e.html, n),
        j(n, "block")) : e.text ? (n.textContent = e.text,
        j(n, "block")) : q(n),
        function(t, e) {
        ...
        S(K(), e.customClass, "content")
    }
      , wt = function() {
        for (var t = _(), e = 0; e < t.length; e++)
            q(t[e])
    }
      , Ct = function() {
        for (var t = U(), e = window.getComputedStyle(t).getPropertyValue("background-color"), n = t.querySelectorAll("[class^=swal2-success-circular-line], .swal2-success-fix"), o = 0; o < n.length; o++)
      ...
      , kt = function(t, i) {
        ...
        a >= i.progressSteps.length && g("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"),
        i.progressSteps.forEach(function(t, e) {
            var n = function(t) {
                var e = document.createElement("li");
                return O(e, C["progress-step"]),
                e.innerHTML = t,
                e
            }(t);
            if (r.appendChild(n),
            e === a && O(n, C["active-progress-step"]),
            e !== i.progressSteps.length - 1) {
                var o = function(t) {
                    var e = document.createElement("li");
                    return O(e, C["progress-step-line"]),
      ...
      , Bt = function(t, e) {
        var n = X();
        S(n, e.customClass, "header"),
        kt(0, e),
        function(t, e) {
            var n = mt.innerParams.get(t);
            if (n && e.type === n.type && z())
                S(z(), e.customClass, "icon");
            else if (wt(),
            e.type)
                if (Ct(),
                -1 !== Object.keys(k).indexOf(e.type)) {
                    var o = D(".".concat(C.icon, ".").concat(k[e.type]));
                    j(o),
                    S(o, e.customClass, "icon"),
        ...
        function(t, e) {
            ...
            V(n, "width", e.imageWidth),
            V(n, "height", e.imageHeight),
            n.className = C.image,
            S(n, e.customClass, "image"),
            e.imageClass && O(n, e.imageClass)
        }(0, e),
        function(t, e) {
            var n = W();
            I(n, e.title || e.titleText),
            e.title && ut(e.title, n),
            e.titleText && (n.innerText = e.titleText),
            S(n, e.customClass, "title")
        }(0, e),
        function(t, e) {
            var n = tt();
            S(n, e.customClass, "closeButton"),
            I(n, e.showCloseButton),
      ...
      , xt = function(t, e) {
        !function(t, e) {
            var n = U();
            V(n, "width", e.width),
            V(n, "padding", e.padding),
            e.background && (n.style.background = e.background),
            n.className = C.popup,
            e.toast ? (O([document.documentElement, document.body], C["toast-shown"]),
            O(n, C.toast)) : O(n, C.modal),
            S(n, e.customClass, "popup"),
            "string" == typeof e.customClass && O(n, e.customClass),
            E(n, C.noanimation, !e.animation)
        }(0, e),
        ft(0, e),
        Bt(t, e),
        yt(t, e),
      ...
      , qt = Object.freeze({
        ...
        queue: function(t) {
            ...
            return new Promise(function(i) {
                !function e(n, o) {
                    n < St.length ? (document.body.setAttribute("data-swal2-queue-step", n),
                    r.fire(St[n]).then(function(t) {
    ...
    function It() {
        ...
        t.showConfirmButton || (q(e.confirmButton),
        t.showCancelButton || q(e.actions)),
        T([e.popup, e.actions], C.loading),
    ...
    function Kt(t, e) {
        ...
        T([document.documentElement, document.body], [C.shown, C["height-auto"], C["no-backdrop"], C["toast-shown"], C["toast-column"]]),
        nt() && (Rt(),
        Dt(),
        _t(),
        zt())
    ...
    function Zt(t) {
        var e = R()
          ...
          , r = o.onClose
          , a = o.onAfterClose;
        n && (null !== r && "function" == typeof r && r(n),
        T(n, C.show),
        O(n, C.hide),
        lt && !x(n, C.noanimation) ? n.addEventListener(lt, Ft.bind(null, n, e, a)) : Kt(e, a),
        i(t || {}))
    }
    var Qt = function(t) {
    ...
    var te = function(t) {
        ...
        t.animation && (O(n, C.show),
        O(e, C.fade)),
        j(n),
        lt && !x(n, C.noanimation) ? (e.style.overflowY = "hidden",
        n.addEventListener(lt, Gt.bind(null, n, e))) : e.style.overflowY = "auto",
        O([document.documentElement, document.body, e], C.shown),
        t.heightAuto && t.backdrop && !t.toast && O([document.documentElement, document.body], C["height-auto"]),
        nt() && (t.scrollbarPadding && Ht(),
        function() {
        ...
        "undefined" != typeof window && Nt() && (Ut(),
        window.addEventListener("resize", Ut)),
        m(document.body.children).forEach(function(t) {
            t === R() || function(t, e) {
                if ("function" == typeof t.contains)
                    return t.contains(e)
            }(t, R()) || (t.hasAttribute("aria-hidden") && t.setAttribute("data-previous-aria-hidden", t.getAttribute("aria-hidden")),
            t.setAttribute("aria-hidden", "true"))
        }),
        setTimeout(function() {
            e.scrollTop = 0
        })),
        ot() || Pt.previousActiveElement || (Pt.previousActiveElement = document.activeElement),
    ...
    var ie, re = Object.freeze({
        ...
        enableConfirmButton: function() {
            v("Swal.disableConfirmButton()", "Swal.getConfirmButton().removeAttribute('disabled')"),
            Yt(this, ["confirmButton"], !1)
        },
        disableConfirmButton: function() {
            v("Swal.enableConfirmButton()", "Swal.getConfirmButton().setAttribute('disabled', '')"),
            Yt(this, ["confirmButton"], !0)
        },
        ...
        _main: function(t) {
            ...
            !function(t) {
                for (var e in t)
                    Vt(i = e) || g('Unknown parameter "'.concat(i, '"')),
                    t.toast && (o = e,
                    -1 !== Mt.indexOf(o) && g('The parameter "'.concat(o, '" is incompatible with toasts'))),
                    jt(n = void 0) && v(n, jt(n));
                var n, o, i
            }(t);
            var l = a({}, Et, t);
            !function(e) {
                ...
                e.animation = b(e.animation),
                (!e.target || "string" == typeof e.target && !document.querySelector(e.target) || "string" != typeof e.target && !e.target.appendChild) && (g('Target parameter is not valid, defaulting to "body"'),
                e.target = "body"),
            ...
            mt.domCache.set(this, d),
            xt(this, l),
            mt.innerParams.set(this, l);
            ...
            return new Promise(function(t) {
                ...
                Wt.swalPromiseResolve.set(c, t),
                l.timer && (Pt.timeout = new Jt(function() {
                    s("timer"),
                    delete Pt.timeout
                }
                ,l.timer)),
                    ...
                    case "click":
                        if (i)
                            ...
                            l.input) {
                                ...
                                l.inputValidator ? (c.disableInput(),
                                Promise.resolve().then(function() {
                ...
                var a = function(t, e) {
                    for (var n = et(l.focusCancel), o = 0; o < n.length; o++)
                ...
                Pt.keydownHandlerAdded = !1),
                l.toast || (Pt.keydownHandler = function(t) {
                    return function(t, e) {
                        ...
                        "Enter" !== t.key || t.isComposing)
                            if ("Tab" === t.key) {
                                ...
                                -1 !== ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Left", "Right", "Up", "Down"].indexOf(t.key) ? document.activeElement === d.confirmButton && H(d.cancelButton) ? d.cancelButton.focus() : document.activeElement === d.cancelButton && H(d.confirmButton) && d.confirmButton.focus() : "Escape" !== t.key && "Esc" !== t.key || !0 !== b(e.allowEscapeKey) || (t.preventDefault(),
                ...
                ,
                Pt.keydownTarget = l.keydownListenerCapture ? window : d.popup,
                Pt.keydownListenerCapture = l.keydownListenerCapture,
                ...
                l.toast && (l.input || l.footer || l.showCloseButton) ? O(document.body, C["toast-column"]) : T(document.body, C["toast-column"]),
                ...
                te(l),
                l.toast || (b(l.allowEnterKey) ? l.focusCancel && H(d.cancelButton) ? d.cancelButton.focus() : l.focusConfirm && H(d.confirmButton) ? d.confirmButton.focus() : a(-1, 1) : document.activeElement && "function" == typeof document.activeElement.blur && document.activeElement.blur()),
    ...
    Object.keys(re).forEach(function(e) {
        ae[e] = function() {
            var t;
            if (ie)
                return (t = ie)[e].apply(t, arguments)
        }
    }),
    ae.DismissReason = t,
    ae.version = "8.8.7";
